...
class OAuth2Client implements ModelInterface, ArrayAccess
{
     ...
     * Sets createdAt
     *
     * @param \DateTime|null $createdAt CreatedAt returns the timestamp of the client's creation. Format: date-time Format: date-time Format: date-time Format: date-time
     *
     * @return $this
     */
     ...
     * Sets updatedAt
     *
     * @param \DateTime|null $updatedAt UpdatedAt returns the timestamp of the last update. Format: date-time Format: date-time Format: date-time Format: date-time
     *
     * @return $this
     */
