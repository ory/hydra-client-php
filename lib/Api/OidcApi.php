...
class OidcApi
{
     ...
     *
     * @param  \Ory\Hydra\Client\Model\OAuth2Client $oAuth2Client Dynamic Client Registration Request Body (required)
     ...
     *
     * @param  \Ory\Hydra\Client\Model\CreateVerifiableCredentialRequestBody|null $createVerifiableCredentialRequestBody createVerifiableCredentialRequestBody (optional)
     ...
     * @throws \Ory\Hydra\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Ory\Hydra\Client\Model\VerifiableCredentialResponse|\Ory\Hydra\Client\Model\VerifiableCredentialPrimingResponse|\Ory\Hydra\Client\Model\ErrorOAuth2
     */
     ...
     * Issues a Verifiable Credential
     *
     * @param  \Ory\Hydra\Client\Model\CreateVerifiableCredentialRequestBody|null $createVerifiableCredentialRequestBody (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createVerifiableCredential'] to see the possible values for this operation
     *
     * @throws \Ory\Hydra\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Ory\Hydra\Client\Model\VerifiableCredentialResponse|\Ory\Hydra\Client\Model\VerifiableCredentialPrimingResponse|\Ory\Hydra\Client\Model\ErrorOAuth2, HTTP status code, HTTP response headers (array of strings)
     */
    public function createVerifiableCredentialWithHttpInfo($createVerifiableCredentialRequestBody = null, string $contentType = self::contentTypes['createVerifiableCredential'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Ory\Hydra\Client\Model\VerifiableCredentialResponse',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\Ory\Hydra\Client\Model\VerifiableCredentialPrimingResponse',
                        $request,
                        $response,
                    );
                default:
    ...
    {
        $returnType = '\Ory\Hydra\Client\Model\VerifiableCredentialResponse';
        $request = $this->createVerifiableCredentialRequest($createVerifiableCredentialRequestBody, $contentType);
     ...
     * @throws \Ory\Hydra\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Ory\Hydra\Client\Model\OidcConfiguration|\Ory\Hydra\Client\Model\ErrorOAuth2
     */
     ...
     * @throws \Ory\Hydra\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Ory\Hydra\Client\Model\OidcConfiguration|\Ory\Hydra\Client\Model\ErrorOAuth2, HTTP status code, HTTP response headers (array of strings)
     */
    public function discoverOidcConfigurationWithHttpInfo(string $contentType = self::contentTypes['discoverOidcConfiguration'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Ory\Hydra\Client\Model\OidcConfiguration',
                        $request,
                        $response,
                    );
                default:
    ...
    {
        $returnType = '\Ory\Hydra\Client\Model\OidcConfiguration';
        $request = $this->discoverOidcConfigurationRequest($contentType);
     ...
     * @throws \Ory\Hydra\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Ory\Hydra\Client\Model\OidcUserInfo|\Ory\Hydra\Client\Model\ErrorOAuth2
     */
     ...
     * @throws \Ory\Hydra\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Ory\Hydra\Client\Model\OidcUserInfo|\Ory\Hydra\Client\Model\ErrorOAuth2, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOidcUserInfoWithHttpInfo(string $contentType = self::contentTypes['getOidcUserInfo'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Ory\Hydra\Client\Model\OidcUserInfo',
                        $request,
                        $response,
                    );
                default:
    ...
    {
        $returnType = '\Ory\Hydra\Client\Model\OidcUserInfo';
        $request = $this->getOidcUserInfoRequest($contentType);
