...
class TrustedOAuth2JwtGrantIssuer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'id' => 'string',
        'issuer' => 'string',
        'publicKey' => '\Ory\Hydra\Client\Model\TrustedOAuth2JwtGrantJsonWebKey',
        'scope' => 'string[]',
        'subject' => 'string'
    ];
    ...
    */
     ...
     * Gets publicKey
     *
     * @return \Ory\Hydra\Client\Model\TrustedOAuth2JwtGrantJsonWebKey|null
     */
     ...
     * Sets publicKey
     *
     * @param \Ory\Hydra\Client\Model\TrustedOAuth2JwtGrantJsonWebKey|null $publicKey publicKey
     *
     * @return self
     */
