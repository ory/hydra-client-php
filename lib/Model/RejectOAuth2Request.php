...
/**
 * RejectOAuth2Request Class Doc Comment
 *
 * @category Class
 * @package  Ory\Hydra\Client
 * @author   OpenAPI Generator team
 ...
 */
class RejectOAuth2Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rejectOAuth2Request';
    ...
    */
     ...
     * Sets errorDebug
     *
     * @param string|null $errorDebug Debug contains information to help resolve the problem as a developer. Usually not exposed to the public but only in the server logs.
     *
     * @return self
     */
     ...
     *
     * @param string|null $errorDescription Description of the error in a human readable format.
     *
     * @return self
     */
     ...
     * Sets errorHint
     *
     * @param string|null $errorHint Hint to help resolve the error.
     *
     * @return self
     */
     ...
     * Sets statusCode
     *
     * @param int|null $statusCode Represents the HTTP status code of the error (e.g. 401 or 403)  Defaults to 400
     *
     * @return self
     */
