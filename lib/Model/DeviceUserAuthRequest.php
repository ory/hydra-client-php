...
/**
 * DeviceUserAuthRequest Class Doc Comment
 *
 * @category Class
 * @package  Ory\Hydra\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeviceUserAuthRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeviceUserAuthRequest';
    ...
    */
     ...
     * Sets challenge
     *
     * @param string $challenge ID is the identifier (\"device challenge\") of the device grant request. It is used to identify the session.
     *
     * @return self
     */
