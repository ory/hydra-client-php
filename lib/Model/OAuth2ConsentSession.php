...
class OAuth2ConsentSession implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'consentRequest' => '\Ory\Hydra\Client\Model\OAuth2ConsentRequest',
        ...
        'remember' => 'bool',
        'rememberFor' => 'int',
        'session' => '\Ory\Hydra\Client\Model\AcceptOAuth2ConsentRequestSession'
    ];
    ...
    */
     ...
     * Gets consentRequest
     *
     * @return \Ory\Hydra\Client\Model\OAuth2ConsentRequest|null
     */
     ...
     * Sets consentRequest
     *
     * @param \Ory\Hydra\Client\Model\OAuth2ConsentRequest|null $consentRequest consentRequest
     *
     * @return self
     */
     ...
     *
     * @param string|null $consentRequestId ConsentRequestID is the identifier of the consent request that initiated this consent session.
     *
     * @return self
     */
     ...
     * Gets session
     *
     * @return \Ory\Hydra\Client\Model\AcceptOAuth2ConsentRequestSession|null
     */
     ...
     * Sets session
     *
     * @param \Ory\Hydra\Client\Model\AcceptOAuth2ConsentRequestSession|null $session session
     *
     * @return self
     */
