...
class CredentialSupportedDraft00 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'cryptographicBindingMethodsSupported' => false,
        'cryptographicSuitesSupported' => false,
        'format' => false,
        'types' => false
    ];
    ...
    {
        $this->setIfExists('cryptographicBindingMethodsSupported', $data ?? [], null);
        $this->setIfExists('cryptographicSuitesSupported', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($cryptographicBindingMethodsSupported)) {
            throw new \InvalidArgumentException('non-nullable cryptographicBindingMethodsSupported cannot be null');
        }
    ...
    {
        if (is_null($cryptographicSuitesSupported)) {
            throw new \InvalidArgumentException('non-nullable cryptographicSuitesSupported cannot be null');
        }
