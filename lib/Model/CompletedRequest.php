 ...
 */
class CompletedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets redirectTo
     *
     * @param string $redirectTo RedirectURL is the URL which you should redirect the user to once the authentication process is completed.
     *
     * @return self
     */
